...
public class UIRestautantPage : MonoBehaviour
{
    ...
    void Start()
    {
        this.sellableItems= DataManager.Instance.StoreItems.Values.Where(item => item.sellType == SellType.restautant).ToList();
    ...
    public void GenerateItems()
    {
        ...
        {
            Debug.LogError("UIRestautantPage GenerateItems foodOptions.Count != itemList.Count");
        }
    }
